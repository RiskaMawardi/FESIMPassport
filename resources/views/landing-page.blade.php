...
<html>
  ...
  <body>
        ...
        <div class="container"><a class="navbar-brand" href="index.html"><img src="../assets/landing-page/img/imigg.png" alt="" width="50%"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item"><a class="nav-link link-scroll" href="/login">Login</a></li>
          </div>
        </div>
      </nav>
    </header>
      ...
      <div class="container py-5">
        <div class="row py-5">
          <div class="col-lg-5 py-5">
            <h2>Selamat datang di situs web<br>Direktorat jendral Imigrasi Indonesia!</h2>
			
            <p class="my-4 text-muted">cari berbagai informasi atau ajukan permohonan keimigrasian</p>
            <ul class="list-inline mb-0">
              <li class="list-inline-item mb-2 mb-lg-0"><a class="btn btn-primary btn-lg px-4" href="/register-user">Daftar di Sini</a></li>
          ...
          <div class="col-lg-6 ml-auto">
            <div class="device-wrapper mx-auto">
              <div class="device shadow" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                <div class="screen"><img class="img-fluid" src="../assets/landing-page/img/dev.png" alt=""></div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="bg-center py-0" id="about" style="background: url(../assets/landing-page/img/service-bg.svg) no-repeat; background-size: cover">
      ...
      <section class="with-pattern-1 py-5" id="services">
        <div class="container py-5">
          <div class="row align-items-center mb-5 gy-5">
            <div class="col-lg-6"><img class="img-fluid w-100 px-lg-5" src="../assets/landing-page/img/objects.svg" alt=""></div>
            <div class="col-lg-6">
    ...
    <section class="p-0" id="testimonials" style="background: url(../assets/landing-page/img/testimonials-bg.png) no-repeat; background-size: 40% 100%; background-position: left center">
