  ...
  <div class="container-scroller d-flex">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/table-pengajuan">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link" href="/upload">Upload Dokumen</a></li>
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="index.html"><img src="../assets/dashboard/images/imi.png" alt="logo" width="120" height="48" viewBox="0 0 120 48"></a>
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="../assets/dashboard/images/logo-mini.svg" alt="logo"/></a>
          </div>
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">Welcome back , @yield('name')</h4>
